    ...
    specs: [
      ...
      },
      {
        ...
        deliverables: [
          ...
          'Dashboard de monitoreo de assets'
        ]
      },
      {
    ...
    specs: [
      {
        ...
        metrics: [
          'Color Accuracy: 99% Rec.709',
          'HDR Support: Dolby Vision',
          'Consistency: 95% cross-device'
        ],
        technologies: ['DaVinci Resolve', 'Color Space', 'HDR', 'ACES', 'LUTs'],
        deliverables: [
          'Presets de color personalizados',
      ...
      },
      {
        ...
        metrics: [
          'Retention Rate: 85% @ 3s',
          'Engagement: 3.2x promedio',
          'Watch Time: +45%'
        ],
        technologies: ['YouTube Analytics', 'Facebook API', 'TikTok Analytics', 'Google Analytics'],
        deliverables: [
          'Mapa de retención visual',
          'Estrategia de hooks',
          'Reportes mensuales de engagement',
      ...
      },
      {
        ...
        deliverables: [
          ...
          'Documentación técnica de codificación'
        ]
      },
      {
...
export default function TechDrawer({ isOpen, serviceId, onClose }: TechDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        ref={drawerRef}
        className="fixed inset-y-0 right-0 w-full md:w-[600px] z-50 bg-[#0A0A0A] border-l border-[#D4AF37]/20 shadow-2xl overflow-y-auto"
